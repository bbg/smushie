...
const variants = {
    ...
    borderR: variant('borderStyles', 'bsr'),
    borderT: variant('borderStyles', 'bst'),
    borderB: variant('borderStyles', 'bsb'),
    borderX: variant('borderStyles', 'bsx'),
    borderY: variant('borderStyles', 'bsy'),
    borderW: variant('borderWidths', 'bw'),
    borderColor: variant('colors', 'bc'),
    borderHoverColor: variant('colors', 'hbc'),
    borderFocusColor: variant('colors', 'fbc'),
    borderDisabledColor: variant('colors', 'dbc'),
    // ---
    p: variant('space', 'p'),
    pl: variant('space', 'pl'),
    pr: variant('space', 'pr'),
    ...
    my: variant('space', 'my'),
    // ---
    w: variant('sizes', 'width'),
    minW: variant('sizes', 'minWidth'),
    maxW: variant('sizes', 'maxWidth'),
    h: variant('sizes', 'height'),
    minH: variant('sizes', 'minHeight'),
    ...
    bgHoverColor: variant('colors', 'hbgc'),
    bgFocusColor: variant('colors', 'fbgc'),
    bgDisabledColor: variant('colors', 'dbgc'),
    // ---
    color: variant('colors', 'color'),
    colorHover: variant('colors', 'htc'),
    colorFocus: variant('colors', 'ftc'),
    colorDisabled: variant('colors', 'dtc'),
    // ---
    gap: variant('space', 'g'),
